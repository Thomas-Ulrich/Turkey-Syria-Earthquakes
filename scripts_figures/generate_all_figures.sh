...
python ~/TuSeisSolScripts/displayh5vtk/plotColorBar.py cork --crange -1 1 --labelfont 8 --hor --height 1.2 3.6 --nticks 3
#python ~/TuSeisSolScripts/displayh5vtk/plotColorBar.py broc --crange -2 2 --labelfont 8 --hor --height 1.2 3.6 --nticks 3

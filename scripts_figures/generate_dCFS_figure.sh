...
python ~/TuSeisSolScripts/displayh5vtk/displayUnstructuredVtk.py $1-fault.xdmf --Data dCFS_Turkey --pvcc pvcc/SEviewTurkey_flatter_2nd.pvcc --last --BoundaryEdges --zoom 2.0 --colorScale roma --winSize 1000 500  --OSR --oneDtMem --output dCFS --clip "0 60e3 0 0.7682212795973759 -1.0 0" --crange " -1.5e6" 1.5e6
